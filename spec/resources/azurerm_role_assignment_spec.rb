...
# Resource: Manages a azurerm_role_assignment resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::AzureRoleAssignment do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { principal_id: 'test-value', scope: 'test-value' } }

  describe ':azurerm_role_assignment' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.azurerm_role_assignment('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'azurerm_role_assignment', 'test')
        validate_required_attributes(config, [:principal_id, :scope])
      end

      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.azurerm_role_assignment('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:azurerm_role_assignment)
      end
      ...
      it 'provides output references' do
        ...
        expect(ref.id).to eq("${azurerm_role_assignment.test.id}")
        expect(ref.condition_version).to eq("${azurerm_role_assignment.test.condition_version}")
        expect(ref.name).to eq("${azurerm_role_assignment.test.name}")
        expect(ref.principal_type).to eq("${azurerm_role_assignment.test.principal_type}")
        expect(ref.role_definition_id).to eq("${azurerm_role_assignment.test.role_definition_id}")
        expect(ref.role_definition_name).to eq("${azurerm_role_assignment.test.role_definition_name}")
        expect(ref.skip_service_principal_aad_check).to eq("${azurerm_role_assignment.test.skip_service_principal_aad_check}")
      end
    end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.azurerm_role_assignment('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      it 'includes condition when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.azurerm_role_assignment('opt', required_attrs.merge(condition: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
      ...
      it 'includes delegated_managed_identity_resource_id when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.azurerm_role_assignment('opt', required_attrs.merge(delegated_managed_identity_resource_id: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'azurerm_role_assignment', 'opt')
        expect(config).to have_key('delegated_managed_identity_resource_id')
      end
      ...
      it 'includes description when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.azurerm_role_assignment('opt', required_attrs.merge(description: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'azurerm_role_assignment', 'opt')
        expect(config).to have_key('description')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.azurerm_role_assignment('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'azurerm_role_assignment', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.azurerm_role_assignment('first', required_attrs)
        synth.azurerm_role_assignment('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'azurerm_role_assignment')
  ...
  it_behaves_like 'a generated pangea resource',
    ...
    method: :azurerm_role_assignment,
    required_attrs: { principal_id: 'test-value', scope: 'test-value' },
