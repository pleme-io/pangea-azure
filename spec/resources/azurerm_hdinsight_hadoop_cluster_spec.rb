...
# Resource: Manages a azurerm_hdinsight_hadoop_cluster resource
  ...
  describe ':azurerm_hdinsight_hadoop_cluster' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        ...
        synth.azurerm_hdinsight_hadoop_cluster('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'azurerm_hdinsight_hadoop_cluster', 'test')
      ...
      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.azurerm_hdinsight_hadoop_cluster('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:azurerm_hdinsight_hadoop_cluster)
      end
      ...
      it 'provides output references' do
        ...
        expect(ref.id).to eq("${azurerm_hdinsight_hadoop_cluster.test.id}")
        expect(ref.https_endpoint).to eq("${azurerm_hdinsight_hadoop_cluster.test.https_endpoint}")
        expect(ref.ssh_endpoint).to eq("${azurerm_hdinsight_hadoop_cluster.test.ssh_endpoint}")
      end
    end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.azurerm_hdinsight_hadoop_cluster('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'azurerm_hdinsight_hadoop_cluster', 'full')
    ...
    context 'optional attributes' do
      ...
      it 'omits compute_isolation when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.azurerm_hdinsight_hadoop_cluster('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'azurerm_hdinsight_hadoop_cluster', 'minimal')
        expect(config).not_to have_key('compute_isolation')
      end
      it 'includes disk_encryption when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.azurerm_hdinsight_hadoop_cluster('opt', required_attrs.merge(disk_encryption: [{ 'key1' => 'val1' }]))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'azurerm_hdinsight_hadoop_cluster', 'opt')
        expect(config).to have_key('disk_encryption')
      end
      ...
      it 'includes storage_account when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.azurerm_hdinsight_hadoop_cluster('opt', required_attrs.merge(storage_account: [{ 'key1' => 'val1' }]))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'azurerm_hdinsight_hadoop_cluster', 'opt')
        expect(config).to have_key('storage_account')
      end
      ...
      it 'includes tags when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.azurerm_hdinsight_hadoop_cluster('opt', required_attrs.merge(tags: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'azurerm_hdinsight_hadoop_cluster', 'opt')
        expect(config).to have_key('tags')
      end
      ...
      it 'includes tls_min_version when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.azurerm_hdinsight_hadoop_cluster('opt', required_attrs.merge(tls_min_version: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'azurerm_hdinsight_hadoop_cluster', 'opt')
        expect(config).to have_key('tls_min_version')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.azurerm_hdinsight_hadoop_cluster('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.azurerm_hdinsight_hadoop_cluster('first', required_attrs)
        synth.azurerm_hdinsight_hadoop_cluster('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'azurerm_hdinsight_hadoop_cluster')
