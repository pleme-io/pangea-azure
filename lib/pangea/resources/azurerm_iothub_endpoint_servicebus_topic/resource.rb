...
require 'pangea/resources/azurerm_iothub_endpoint_servicebus_topic/types'
require 'pangea/resource_registry'

module Pangea::Resources
  module AzureIothubEndpointServicebusTopic
    include Pangea::Resources::ResourceBuilder

    define_resource :azurerm_iothub_endpoint_servicebus_topic,
