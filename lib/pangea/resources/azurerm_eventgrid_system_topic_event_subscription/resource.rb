...
require 'pangea/resources/azurerm_eventgrid_system_topic_event_subscription/types'
require 'pangea/resource_registry'

module Pangea::Resources
  module AzureEventgridSystemTopicEventSubscription
    include Pangea::Resources::ResourceBuilder

    define_resource :azurerm_eventgrid_system_topic_event_subscription,
