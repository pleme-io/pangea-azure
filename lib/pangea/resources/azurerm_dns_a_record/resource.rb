...
module Pangea
  module Resources
    module AzurermDnsARecord
      def azurerm_dns_a_record(name, attributes = {})
        attrs = Azure::Types::DnsARecordAttributes.new(attributes)

        resource(:azurerm_dns_a_record, name) do
        ...
        ResourceReference.new(
          ...
          outputs: {
            id: "${azurerm_dns_a_record.#{name}.id}",
            fqdn: "${azurerm_dns_a_record.#{name}.fqdn}"
          }
        )
      end
    end
